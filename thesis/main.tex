...
% ---
\titulo{Exact Markov Chain Monte Carlo Methods for the Normalized Power Prior}
\autor{Eduardo Adame}
...
\begin{dedicatoria}
  ...
  \centering
  \noindent
  \textit{ To anyone who has ever believed in Education as the main way to overcome adversity. } \vspace*{\fill}
\end{dedicatoria}
% ---
...
\begin{epigrafe}
    \vspace*{\fill}
	    \begin{flushright}
            ...
            {\tiny \itshape ``Now, I was* the hero, and my horse only spoke* in English...''}
